...
- **Metadata**: Ordered doubly-linked list of IDs with O(1) head/tail access
...
var l1Store = new Store<string>(100, 1000, null, loggerFactory); // Min: 100, Max: 1000, no ID gen
