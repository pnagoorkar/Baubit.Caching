...
namespace Baubit.Caching
{
    ...
    {
        /// <summary>
        /// Gets an asynchronous enumerator with a specified identifier that can wait for future elements.
        /// </summary>
        ...
        IAsyncEnumerator<T> GetFutureAsyncEnumerator(string id = null, CancellationToken cancellationToken = default);
    }
}
