...
{
    /// <summary>
    /// In-memory implementation of <see cref="IStore{TId, TValue}"/> using a dictionary for storage.
    /// Provides O(1) lookups and supports generic identifier types.
    /// Thread-safe when used with external synchronization (e.g., via OrderedCache's locking).
    /// </summary>
    ...
    {
        /// <summary>
        /// Internal dictionary mapping entry IDs to their corresponding entries.
        /// </summary>
        private readonly Dictionary<TId, IEntry<TId, TValue>> data = new Dictionary<TId, IEntry<TId, TValue>>();
        
        /// <summary>
        /// Tracks the last ID generated by this store for ID continuity.
        /// </summary>
        private TId? lastGeneratedId;
        
        /// <summary>
        /// Factory function to generate the next ID based on the last generated ID.
        /// Returns null if ID generation is not supported by this store instance.
        /// </summary>
