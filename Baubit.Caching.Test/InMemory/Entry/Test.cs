...
namespace Baubit.Caching.Test.InMemory.Entry
{
    ...
    public class Test
    {
        ...
        public void Entry_Constructor_SetsProperties()
        {
            ...
            // Act
            var entry = new Baubit.Caching.InMemory.Entry<Guid, string>(id, value);
        ...
        public void Entry_WithIntValue_StoresCorrectly()
        {
            ...
            // Act
            var entry = new Baubit.Caching.InMemory.Entry<Guid, int>(id, value);
        ...
        public void Entry_WithComplexType_StoresCorrectly()
        {
            ...
            // Act
            var entry = new Baubit.Caching.InMemory.Entry<Guid, object>(id, value);
        ...
        {
            // Arrange & Act
            var entry1 = new Baubit.Caching.InMemory.Entry<Guid, string>(Guid.NewGuid(), "test1");
            Thread.Sleep(5); // Small delay to ensure different timestamp
            var entry2 = new Baubit.Caching.InMemory.Entry<Guid, string>(Guid.NewGuid(), "test2");
